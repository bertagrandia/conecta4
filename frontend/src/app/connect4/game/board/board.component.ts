...
@Component({
  ...
  styles: [`
    ...
    .preview-disc.blue   { background: #4361EE; }
    ...
    .disc.blue {
      background: radial-gradient(circle at 35% 35%, #7b96f8, #4361EE);
      box-shadow: 0 3px 10px rgba(67,97,238,0.6);
    }
    ...
    @keyframes glow-blue   { from { filter: brightness(1); } to { filter: brightness(1.6) drop-shadow(0 0 10px #4361EE); } }
